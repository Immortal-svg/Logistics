...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td  colspan="2">
            <form action="${pageContext.request.contextPath}/balance/selBalanceall" method="post" name="form1" >
    	...
    	<c:forEach items="${selectfinance.getRecords()}" var="cust">
	    	<tr>
				...
				<tr>
					<td colspan="2" >
						<a href="${pageContext.request.contextPath}/balance/selBalanceall?thispage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<c:if test="${selectfinance.hasPrevious()==true}">
							<a href="${pageContext.request.contextPath}/balance/selBalanceall?thispage=${selectfinance.getCurrent() <= selectfinance.getPages()? selectfinance.getCurrent()-1:userspage.getCurrent()}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${selectfinance.hasNext()==true}">
							<a href="${pageContext.request.contextPath}/balance/selBalanceall?thispage=${selectfinance.getCurrent() <= selectfinance.getPages()? selectfinance.getCurrent()+1:userspage.getCurrent()}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="${pageContext.request.contextPath}/balance/selBalanceall?thispage=${selectfinance.getPages()}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						第${selectfinance.current }页&nbsp;&nbsp;&nbsp;&nbsp;
						共${selectfinance.getPages() }页&nbsp;&nbsp;&nbsp;&nbsp;
						共${selectfinance.total}家客户&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
    </table>
