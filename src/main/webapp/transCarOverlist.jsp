    ...
    <%--    <tr>
    	...
    	<tr>
    		...
    		<td align="center" class="STYLE1" nowrap="nowrap" style="BORDER: #c1dad7 1px solid">操作</td>
				...
				<c:forEach items="${daozhan.getRecords()}" var="car">
					<tr>
        ...
        <tr>
        	<td colspan="2">
				<a href="${pageContext.request.contextPath}/transcar/selArriveTrans?thispage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${daozhan.hasPrevious()==true}">
					<a href="${pageContext.request.contextPath}/transcar/selArriveTrans?thispage=${daozhan.getCurrent() <= daozhan.getPages()? daozhan.getCurrent()-1:daozhan.getCurrent()}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<c:if test="${daozhan.hasNext()==true}">
					<a href="${pageContext.request.contextPath}/transcar/selArriveTrans?thispage=${daozhan.getCurrent() <= daozhan.getPages()? daozhan.getCurrent()+1:daozhan.getCurrent()}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<a href="${pageContext.request.contextPath}/transcar/selArriveTrans?thispage=${daozhan.getPages()}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				第${daozhan.current }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${daozhan.getPages() }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${daozhan.total}趟车&nbsp;&nbsp;&nbsp;&nbsp;
        	</td>
        </tr>
    </table>
