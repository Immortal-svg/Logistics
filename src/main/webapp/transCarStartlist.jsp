...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
      ...
      <%--  <tr>
    	...
    	<c:forEach items="${pagecarStatus.getRecords()}" var="car">
	    	<tr>
	    		...
	    		<td class="STYLE1" nowrap="nowrap" style="BORDER: #c1dad7 1px solid" align="center">
	    			...
	    			<a href="${pageContext.request.contextPath}/transcar/updSetTrans?transID=${car.transID }">发车</a>&nbsp;&nbsp;
        ...
        <tr>
        	<td colspan="2">
				<a href="${pageContext.request.contextPath}/transcar/selTransNotStrat?thispage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${pagecarStatus.hasPrevious()==true}">
					<a href="${pageContext.request.contextPath}/transcar/selTransNotStrat?thispage=${pagecarStatus.getCurrent() <= pagecarStatus.getPages()? pagecarStatus.getCurrent()-1:pagecarStatus.getCurrent()}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<c:if test="${pagecarStatus.hasNext()==true}">
					<a href="${pageContext.request.contextPath}/transcar/selTransNotStrat?thispage=${pagecarStatus.getCurrent() <= pagecarStatus.getPages()? pagecarStatus.getCurrent()+1:pagecarStatus.getCurrent()}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<a href="${pageContext.request.contextPath}/transcar/selTransNotStrat?thispage=${pagecarStatus.getPages()}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				第${pagecarStatus.current }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${pagecarStatus.getPages() }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${pagecarStatus.total}趟车&nbsp;&nbsp;&nbsp;&nbsp;
        	</td>
        </tr>
    </table>
  </div></div></div></div>
