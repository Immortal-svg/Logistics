...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <script language="javascript">
                ...
                $(function(){
                    $("#sendTypeName").blur(function () {
                        ...
                        $.ajax({
                            type:"post",
                            url:"${pageContext.request.contextPath}/sendtype/isAreaEixt",
                            dataType:"json",
                            data:{"sendTypeName":name},
                            success:function (data) {
                                if(data.sendTypeName!=null){
                                    i="1";
            ...
            <form action="${pageContext.request.contextPath}/sendtype/insSendType" method="post" name="form1" onsubmit="return check()">
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="sendTypeName" id="sendTypeName">
                <span id="p"></span>
                </td>
			  </tr>
			   <tr>
