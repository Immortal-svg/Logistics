...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <div align="center">
            <img src="${pageContext.request.contextPath}/images/ico_Form.gif" width="14" height="14" />&nbsp;<a href='${pageContext.request.contextPath}/transcar/insTrans' >新增</a>&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <%-- <tr>
    	...
    	<script language="javascript">
			...
			$(function (){
				$("#dele").click(function(){
					$.ajax({
						type:"post",
						url:"${pageContext.request.contextPath}/transcar/iscarStatus",
						dateType:"json",
						data:{"transID":transID},
						success:function(data){
							val=data.carStatus;
							alert(data.carStatus);
						}
					});

				});
			});
    		function testDel(transID){
    		/*	alert(transID);*/
    			alert(val);
    			if (val!="未发车" ){
    				alert("已发车不能删除");
    	...
    	<c:forEach items="${transcarPage.records}" var="car">
	    	<tr>
	    		...
	    		<td class="STYLE1" nowrap="nowrap" style="BORDER: #c1dad7 1px solid" align="center">
	    			...
	    			<a href="${pageContext.request.contextPath}/transcar/updCar?ransID=${car.transID }">修改</a>&nbsp;&nbsp;
	    			<a href="${pageContext.request.contextPath}/transcar/delTrans?transID=${car.transID }" onclick="return testDel(${car.transID }) " id="dele"  >删除</a>
				</td>
	    	</tr>    	
    	</c:forEach>
    </table>
        ...
        <tr>
        	<td colspan="2">
				<a href="${pageContext.request.contextPath}/transcar/selectTrancarAll?thispage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${transcarPage.hasPrevious()==true}">
					<a href="${pageContext.request.contextPath}/transcar/selectTrancarAll?thispage=${transcarPage.getCurrent() <= transcarPage.getPages()? transcarPage.getCurrent()-1:transcarPage.getCurrent()}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<c:if test="${transcarPage.hasNext()==true}">
					<a href="${pageContext.request.contextPath}/transcar/selectTrancarAll?thispage=${transcarPage.getCurrent() <= transcarPage.getPages()? transcarPage.getCurrent()+1:transcarPage.getCurrent()}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<a href="${pageContext.request.contextPath}/transcar/selectTrancarAll?thispage=${transcarPage.getPages()}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				第${transcarPage.current }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${transcarPage.getPages() }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${transcarPage.total}趟车&nbsp;&nbsp;&nbsp;&nbsp;
        	</td>
        </tr>
    </table>
  </div></div></div></div>
