...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <script language="javascript">
                ...
                $(function(){
                    $("#orderName").blur(function () {
                        ...
                        $.ajax({
                            type:"post",
                            url:"${pageContext.request.contextPath}/orderstatus/isAreaEixt",
                            dataType:"json",
                            data:{"orderName":name},
            ...
            <form action="${pageContext.request.contextPath}/orderstatus/insOrders" method="post" name="form1" onsubmit="return check();">
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="orderName" id="orderName">
                 <span id="p"></span>
                </td>
			  </tr>
			   <tr>
