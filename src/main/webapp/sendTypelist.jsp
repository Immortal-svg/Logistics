...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <img src="${pageContext.request.contextPath}/images/ico_Form.gif" width="14" height="14" />&nbsp;
				<a href='${pageContext.request.contextPath}/sendTypeAdd.jsp' >新增</a>&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <%--     <tr>
        ...
        <tr>
            <td  colspan="2">
             ...
             <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  ...
			  <c:forEach items="${Sendtypepage.getRecords()}" var="send">
			   <tr>
			    ...
			    <td class="STYLE1"  style="BORDER: #c1dad7 1px solid"><div align="center">
			    	<a href="${pageContext.request.contextPath}/sendtype/updSendType?sendTypeID=${send.sendTypeID }">修改</a>&nbsp;&nbsp;
			    	<a href="${pageContext.request.contextPath}/sendtype/delSendType?sendTypeID=${send.sendTypeID } " onclick="return confirm('删除确认')">删除</a>&nbsp;&nbsp;
        ...
        <tr>
        	<td colspan="2">
				<a href="${pageContext.request.contextPath}/sendtype/selectAllsendtype?thispage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<c:if test="${Sendtypepage.hasPrevious()==true}">
					<a href="${pageContext.request.contextPath}/sendtype/selectAllsendtype?thispage=${Sendtypepage.getCurrent() <= Sendtypepage.getPages()? Sendtypepage.getCurrent()-1:Sendtypepage.getCurrent()}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<c:if test="${Sendtypepage.hasNext()==true}">
					<a href="${pageContext.request.contextPath}/sendtype/selectAllsendtype?thispage=${Sendtypepage.getCurrent() <= Sendtypepage.getPages()? Sendtypepage.getCurrent()+1:Sendtypepage.getCurrent()}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
				<a href="${pageContext.request.contextPath}/sendtype/selectAllsendtype?thispage=${Sendtypepage.getPages()}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				第${Sendtypepage.current }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${Sendtypepage.getPages() }页&nbsp;&nbsp;&nbsp;&nbsp;
				共${Sendtypepage.total}种运输工具&nbsp;&nbsp;&nbsp;&nbsp;
        	</td>
        </tr>
    </table>
  </div></div></div></div>
