...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <script language="javascript">
                ...
                $(function(){
                    $("#paidName").blur(function () {
                        ...
                        $.ajax({
                            type:"post",
                            url:"${pageContext.request.contextPath}/paidtype/isAreaEixt",
                            dataType:"json",
                            data:{"paidName":name},
                            success:function (data) {

                                if(data.paidName!=null){
                                    i="1";
            ...
            <form action="${pageContext.request.contextPath}/paidtype/insPaidType" method="post" name="form1" onsubmit="return check()">
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="paidName" id="paidName">
                <span id="p"></span>
                </td>
			  </tr>
			   <tr>
