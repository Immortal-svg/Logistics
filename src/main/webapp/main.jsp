...
<DIV class=body_header>
	...
	<DIV class=shortcut-buttons-set style="MARGIN-RIGHT: 40px">
		<a href="${pageContext.request.contextPath}/users/exit" onclick="return logoutsys();">
			<IMG title=退出系统  border="0" alt=退出系统 src="${pageContext.request.contextPath }/images/layout.jpg"></a>
	</DIV>
	<DIV class=shortcut-buttons-set><a href="${pageContext.request.contextPath}/right.jsp" target="mainFrame">
		<IMG title=系统首页  border="0" alt=系统首页 src="${pageContext.request.contextPath }/images/index.jpg"></a>
	</DIV>
	<DIV id=profile-links>
		<DIV id=usertip>当前用户:${users.userName } </DIV>
		<DIV id=smstip>
		<div style="display:block;">所在部门:<SPAN id=remainpoint>${users.depName}部</SPAN></div>
	</DIV>
</DIV>
</DIV>
<DIV id=body-wrapper>
...
<DIV id=menubg>
<IFRAME id=leftFrame name=leftFrame src="${pageContext.request.contextPath}/left.jsp" frameBorder=0 onload="Javascript:SetCwinHeight('leftFrame')"></IFRAME></DIV></DIV>
...
name=mainFrame src="${pageContext.request.contextPath}/right.jsp" frameBorder=0 onload="Javascript:SetCwinHeight('mainFrame')"></IFRAME></DIV></DIV>
