	...
	<div class="content-box role">
		<div class="content-box-content">
										...
										<td width="20%" align="right">
											<div align="center">
												<img src="${pageContext.request.contextPath}/images/ico_Form.gif" width="14" height="14" />&nbsp;<a
													href='${pageContext.request.contextPath}/cardetail/insCarDetail'>新增</a>&nbsp;&nbsp;&nbsp;&nbsp;
												<img src="${pageContext.request.contextPath}/images/ico_Form.gif" width="14" height="14" />&nbsp;<a
			...
			<%--			<tr>
						...
						<tr>
							<td colspan="2">
								...
								<table align="center" width="800" cellpadding="3"
									...
									<c:forEach items="${cardetailpage.getRecords()}" var="car">
										...
										<tr>
											...
											<td class="STYLE1" nowrap="nowrap"
												...
												href="${pageContext.request.contextPath}/cardetail/updCarDetail?detailID=${car.detailID }">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
												<a
												href="${pageContext.request.contextPath}/cardetail/delCarDetail?detailID=${car.detailID }"
						...
						<tr>
							<td colspan="2">
								<a href="${pageContext.request.contextPath}/cardetail/selCarDetail?thispage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<c:if test="${cardetailpage.hasPrevious()==true}">
									<a href="${pageContext.request.contextPath}/cardetail/selCarDetail?thispage=${cardetailpage.getCurrent() <= cardetailpage.getPages()? cardetailpage.getCurrent()-1:cardetailpage.getCurrent()}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
								</c:if>
								<c:if test="${cardetailpage.hasNext()==true}">
									<a href="${pageContext.request.contextPath}/cardetail/selCarDetail?thispage=${cardetailpage.getCurrent() <= cardetailpage.getPages()? cardetailpage.getCurrent()+1:cardetailpage.getCurrent()}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
								</c:if>
								<a href="${pageContext.request.contextPath}/cardetail/selCarDetail?thispage=${cardetailpage.getPages()}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
								第${cardetailpage.current }页&nbsp;&nbsp;&nbsp;&nbsp;
								共${cardetailpage.getPages() }页&nbsp;&nbsp;&nbsp;&nbsp;
								共${cardetailpage.total}笔订单&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
					</table>
				</div>
			</div>
